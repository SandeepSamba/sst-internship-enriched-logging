...
public class TestClass {
   ...
   LogMessage logmessage = new LogMessage("info","72363","Cal","add","main",attributes,attributetype,null);
   ...
   LogMessage logmessage1 = new LogMessage("info","72363","Cal","sub","main",attributes,attributetype,null);
   @Test
   ...
   LogMessage logmessage2 = new LogMessage("info","72363","Cal","add","main",attributes,attributetype,null);
   @Test
